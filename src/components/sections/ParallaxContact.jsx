  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto text-center px-4 py-10 rounded-2xl backdrop-blur-md bg-white dark:bg-gray-900/60 shadow-2xl">
        ...
        <button
          className="px-8 py-3 rounded-full bg-blue-700 text-white font-bold text-lg shadow-lg hover:bg-blue-900 transition-colors duration-300 animate-fade-in-up delay-200"
